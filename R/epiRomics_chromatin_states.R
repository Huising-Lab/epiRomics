...
epiRomics_chromatin_states <- function(
    epiRomics_dB, histone_marks = NULL,
...
epiRomics_chromatin_states_categories <- function(
  ...
  setup <- .chromatin_state_setup(
    epiRomics_dB, histone_marks, regions,
    refine_by_tss, tss_window,
...
#' @noRd
.detect_histone_marks <- function(epiRomics_dB, histone_marks, caller) {
...
#' @noRd
.resolve_classification_regions <- function(epiRomics_dB, annot_by_type,
...
#' @noRd
.compute_tss_proximity <- function(regions, n_regions, epiRomics_dB,
                                    refine_by_tss, tss_window) {
...
.compute_marks_present <- function(overlap_matrix, histone_marks, n_regions,
                                    epiRomics_dB, genome, annot_by_type,
                                    regions) {
...
.chromatin_state_setup <- function(epiRomics_dB, histone_marks, regions,
  ...
  histone_marks <- .detect_histone_marks(epiRomics_dB, histone_marks, caller)
  ...
  regions <- .resolve_classification_regions(
    epiRomics_dB, annot_by_type, mark_db_names, histone_marks, regions
  )
  ...
  genomic_context <- .compute_tss_proximity(
    regions, n_regions, epiRomics_dB, refine_by_tss, tss_window
  )

  summary_cols <- .compute_marks_present(
    overlap_info$overlap_matrix, histone_marks, n_regions,
    epiRomics_dB, genome, annot_by_type, regions
  )
