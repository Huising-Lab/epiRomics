...
#'
#' @param epiRomics_db_file character string of path to
...
#' @param epiRomics_genome a character string containing
#'   the genome associated with your data.
#'   e.g. "mm10" or "hg38".
#' @param epiRomics_organism a character string
...
#' @examples
#' tryCatch(
#'   epiRomics_build_dB("nonexistent.csv"),
#'   error = function(e) message(e$message)
#' )
#' \donttest{
#' epiRomics_dB <- epiRomics_build_dB(
#'   epiRomics_data_path, epiRomics_meta, "mm10"
#' )
#' }
epiRomics_build_dB <-
  function(epiRomics_db_file,
    ...
    validate_character_param(
      epiRomics_genome, "epiRomics_genome",
      "epiRomics_build_dB"
    )
    validate_character_param(
      epiRomics_organism, "epiRomics_organism",
      "epiRomics_build_dB"
    )
