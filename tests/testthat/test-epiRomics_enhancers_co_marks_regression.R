# ============================================================================
# REGRESSION BASELINE TESTS for epiRomics_enhancers_co_marks
#
...
#
# Note: epiRomics_enhancers_co_marks returns an epiRomicsS4 object.
...
test_that("enhancers_co_marks regression: default marks", {
  ...
  result <- epiRomics_enhancers_co_marks(dB)
...
test_that("enhancers_co_marks regression: custom marks", {
  ...
  result <- epiRomics_enhancers_co_marks(dB,
    ...
    epiRomics_histone_mark_2 = "h3k27me3")
  result_df <- base::as.data.frame(result@annotations)
