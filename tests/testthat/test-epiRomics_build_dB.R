...
# Test: epiRomics_build_dB returns correct S4 class and expected output
testthat::test_that("epiRomics_build_dB returns correct S4 class and expected output", {
  skip_if_no_extdata()
  db_sheet <- make_db_sheet()
  suppressWarnings({
    result <- epiRomics::epiRomics_build_dB(
