# ============================================================================
# REGRESSION BASELINE TESTS for benchmark_enhancer_predictor
#
...
#
# benchmark_enhancer_predictor computes overlap fractions between
...
test_that("enhancer_predictor_to_ref regression: default", {
  ...
  result <- benchmark_enhancer_predictor(dB,
    histone = "h3k4me1",
    curated_database = "TF1")
