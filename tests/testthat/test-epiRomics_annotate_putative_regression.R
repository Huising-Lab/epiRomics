## Regression baseline tests for epiRomics_annotate_putative
##
...
test_that("annotate_putative regression: default", {
  ...
  # epiRomics_annotate_putative checks for functional databases in dB.
  ...
  result <- base::suppressWarnings(base::suppressMessages(
    epiRomics_annotate_putative(pe_df, dB)
  ))
