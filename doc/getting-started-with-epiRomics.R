...
example_epiRomics_Db_sheet <-
  read.csv(file = system.file("extdata", "example_epiRomics_Db_sheet_user_paths.csv", package = "epiRomics"))

## ----data format and load-----------------------------------------------------
...
epiRomics_putative_enhancers_filtered_fantom <-
  epiRomics_enhancers_filter(epiRomics_putative_enhancers, epiRomics_dB, epiRomics_type ="hg38_custom_fantom")

# Taking a look, we see a reduced number of 2,749 candidate regions  

epiRomics_putative_enhancers_filtered_fantom@annotations

## ----putative enhancers filtering active regulome-----------------------------
...
epiRomics_putative_enhancers_filtered_regulome_active <-
  epiRomics_enhancers_filter(epiRomics_putative_enhancers, epiRomics_dB, epiRomics_type ="hg38_custom_regulome_active")
...
## ----putative enhancers filtering super regulome------------------------------
...
epiRomics_putative_enhancers_filtered_regulome_super <-
  epiRomics_enhancers_filter(epiRomics_putative_enhancers, epiRomics_dB, epiRomics_type ="hg38_custom_regulome_super")
...
## ----putative enhancers filtering ucnes---------------------------------------
...
epiRomics_putative_enhancers_filtered_ucnes <-
  epiRomics_enhancers_filter(epiRomics_putative_enhancers, epiRomics_dB, epiRomics_type ="hg38_custom_ucnes")


epiRomics_putative_enhancers_filtered_ucnes@annotations

## ----putative enhancers to enhanceosome---------------------------------------
...
head(as.data.frame(epiRomics_putative_enhanceosome_fantom@annotations)[as.data.frame(epiRomics_putative_enhanceosome_fantom@annotations)$seqnames=="chr1",])
...
epiRomics_track_connection <- read.csv(system.file(
        "extdata",
...
epiRomics_track_layer_human(
    epiRomics_putative_enhanceosome_fantom,
    epiRomics_index = which(names(epiRomics_putative_enhanceosome_fantom@annotations)== 183),
    epiRomics_dB = epiRomics_dB,
    epiRomics_track_connection = epiRomics_track_connection
)

## ----data regulome active visual----------------------------------------------
...
epiRomics_putative_enhanceosome_regulome_active <-
  epiRomics_enhanceosome(epiRomics_putative_enhancers_filtered_regulome_active, epiRomics_dB)


epiRomics_putative_enhanceosome_regulome_active@annotations

# Evaluate calls on chromosome 1
head(as.data.frame(epiRomics_putative_enhanceosome_regulome_active@annotations)[as.data.frame(epiRomics_putative_enhanceosome_regulome_active@annotations)$seqnames=="chr1",])

# Find Index
which(names(epiRomics_putative_enhanceosome_regulome_active@annotations)== 82)
...
epiRomics_track_layer_human(
    epiRomics_putative_enhanceosome_regulome_active,
    epiRomics_index = which(names(epiRomics_putative_enhanceosome_regulome_active@annotations)== 82),
    epiRomics_dB = epiRomics_dB,
    epiRomics_track_connection = epiRomics_track_connection
)

## ----data regulome super visual-----------------------------------------------
...
epiRomics_putative_enhanceosome_regulome_super <-
  epiRomics_enhanceosome(epiRomics_putative_enhancers_filtered_regulome_super, epiRomics_dB)
...
# Evaluate calls on chromosome 1
head(as.data.frame(epiRomics_putative_enhanceosome_regulome_super@annotations)[as.data.frame(epiRomics_putative_enhanceosome_regulome_super@annotations)$seqnames=="chr1",])
...
epiRomics_track_layer_human(
    epiRomics_putative_enhanceosome_regulome_super,
    epiRomics_index = which(names(epiRomics_putative_enhanceosome_regulome_super@annotations)== 1),
    epiRomics_dB = epiRomics_dB,
    epiRomics_track_connection = epiRomics_track_connection
)
...
epiRomics_enhancers_filter(epiRomics_enhancers_filter(epiRomics_enhancers_filter(epiRomics_enhancers_filter(epiRomics_putative_enhancers, epiRomics_dB, epiRomics_type ="hg38_custom_fantom"), epiRomics_dB,epiRomics_type="hg38_custom_regulome_active"), epiRomics_dB, epiRomics_type="hg38_custom_regulome_super"), epiRomics_dB, epiRomics_type ="hg38_custom_ucnes")
...
epiRomics_putative_enhanceosome_stringent <-
  epiRomics_enhanceosome(epiRomics_putative_enhancers_filtered_stringent, epiRomics_dB)
...
beta_enhancer_regions <- epiRomics_regions_of_interest(epiRomics_putative_enhanceosome_fantom,beta.enriched)
...
epiRomics_track_layer_human(beta_enhancer_regions,
                      epiRomics_index = 1,
                      epiRomics_dB = epiRomics_dB,
                      epiRomics_track_connection = epiRomics_track_connection
)
